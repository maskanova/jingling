...
function() {
    ...
    var m = (l.navigator || {}).userAgent,
        ...
        a = v,
        t = !!r.document,
        M = !!i.documentElement && !!i.head && "function" == typeof i.addEventListener && "function" == typeof i.createElement,
        ...
        y = ["xs", "sm", "lg", "fw", "ul", "li", "border", "pull-left", "pull-right", "spin", "pulse", "rotate-90", "rotate-180", "rotate-270", "flip-horizontal", "flip-vertical", "stack", "stack-1x", "stack-2x", "inverse", "layers", "layers-text", "layers-counter"].concat(d.map(function(c) {
            return c + "x"
    ...
    var T = P[f],
        _ = [],
        R = !1;
    M && ((R = (i.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(i.readyState)) || i.addEventListener("DOMContentLoaded", function c() {
        i.removeEventListener("DOMContentLoaded", c), R = 1, _.map(function(c) {
            return c()
        })
    }));
    var F = function(c) {
    ...
    function mc(c) {
        ...
        a && (t[g] = "");
        var M, f, r, i, H, n, V, o, C, L = A({}, s.styles);
        Q(v) && (L.transform = (f = (M = {
            transform: v,
            startCentered: !0,
            width: h,
            height: z
        }).transform, r = M.width, i = void 0 === r ? b : r, H = M.height, n = void 0 === H ? b : H, V = M.startCentered, C = "", C += (o = void 0 !== V && V) && p ? "translate(" + (f.x / I - i / 2) + "em, " + (f.y / I - n / 2) + "em) " : o ? "translate(calc(-50% + " + f.x / I + "em), calc(-50% + " + f.y / I + "em)) " : "translate(" + f.x / I + "em, " + f.y / I + "em) ", C += "scale(" + f.size / I * (f.flipX ? -1 : 1) + ", " + f.size / I * (f.flipY ? -1 : 1) + ") ", C += "rotate(" + f.rotate + "deg) "), L["-webkit-transform"] = L.transform);
        var u = J(L);
    ...
    function yc(h, c) {
        ...
        0 === h.length ? z() : (r.requestAnimationFrame || function(c) {
            ...
            var c = !0 === E.autoReplaceSvg ? wc.replace : wc[E.autoReplaceSvg] || wc.replace,
                l = Mc.begin("mutate");
            h.map(c), l(), z()
        })
    }
        ...
        if (e && E.observeMutations) {
            ...
            xc = new e(function(c) {
                kc || X(c).forEach(function(c) {
                    if ("childList" === c.type && 0 < c.addedNodes.length && !Sc(c.addedNodes[0]) && (E.searchPseudoElements && s(c.target), v(c.target)), "attributes" === c.type && c.target.parentNode && E.searchPseudoElements && s(c.target.parentNode), "attributes" === c.type && Sc(c.target) && ~w.indexOf(c.attributeName))
    ...
    function Zc(c) {
        var l, h, z, v, m, s, e, a, t, M, f, r, i, H, n, V, o, C, L, u = (h = Oc(l = c), z = h.iconName, v = h.prefix, m = h.rest, s = qc(l), e = Ec(l), a = Pc(l), t = Tc(l), M = _c(l), {
            iconName: z,
        ...
        }(c, u) : (f = c, i = (r = u).iconName, H = r.title, n = r.prefix, V = r.transform, o = r.symbol, C = r.mask, L = r.extra, [f, vc({
            icons: {
                main: Qc(i, n),
    ...
    function cl(c) {
        ...
        if (M) {
            var h = i.documentElement.classList,
                z = function(c) {
                    return h.add(C + "-" + c)
                },
                v = function(c) {
        ...
        fl = (el = function(c) {
            ...
            if (c) {
                ...
                return ml(A({
                    ...
                    return vl(), E.autoA11y && (t ? i["aria-labelledby"] = E.replacementClass + "-title-" + D() : i["aria-hidden"] = "true"), vc({
                        icons: {
                            main: zl(C),
                            mask: e ? zl(e.icon) : {
                                found: !1,
    ...
    ! function(c) {
        ...
        t && (r.FontAwesome || (r.FontAwesome = rl), F(function() {
            ...
            addPack: function(c, l) {
                T.styles[c] = A({}, T.styles[c] || {}, l), oc(), il()
            },
            addShims: function(c) {
                var l;
                (l = T.shims).push.apply(l, j(c)), oc(), il()
            }
        })
    })
}();
